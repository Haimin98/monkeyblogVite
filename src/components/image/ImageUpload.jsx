...
const ImageUpload = (props) => {
  ...
  return (
    <label
      className={`cursor-pointer flex items-center justify-center border border-dashed min-h-[200px] rounded-lg ${className} relative overflow-hidden group bg-gray-200`}
    >
      <input
        type="file"
        name={name}
